...
export default function CipherPage() {
  return (
    /* Adjust pt-[94px] below to change distance from the top of the screen */
    <main className="relative h-screen max-h-screen w-full overflow-hidden bg-transparent pt-[94px]">
      <Suspense
        fallback={
